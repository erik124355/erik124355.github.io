...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $stmt = $conn->prepare("SELECT asiakasid, sahkoposti, salasana FROM vkauppa_asiakas WHERE sahkoposti = ?");
    ...
    } elseif (!password_verify($password, $user["salasana"])) {
        $message = "❌ Väärä sähköposti tai salasana.";
    } else {
        $_SESSION["user_id"] = $user["asiakasid"];
        ...
        <div class="glass-card-login">
            <div class="content">
                <div class="header-row-2" style="margin: 20px; padding: 20px;">
                    ...
                    <div>
                        <h1 class="tauri-regular text-color-1" style="margin-top:30px">Kirjautuminen</h1>
                        <br>
                        <p class="zalando-sans text-color-1">Kirjaudu sisään, niin pääset tilaamaan tuotteita.</p>
                        <br>
                    ...
                    <div>
                        <form method="POST" action="" >
                            ...
                            <br>
                            <br>
                            <button class="button-2" type="submit" class="zalando-sans button-1">Kirjaudu sisään</button>
                            <br>
                            <br>
                            <div class="divider">TAI</div>
                            <br>
                            <p class="zalando-sans text-color-1">Ei vielä käyttäjää? Rekisteröidy <a class="link" href="rekisteroityminen.php">täältä.</a></p>
                        </form>
                    </div>
                </div>
            </div>
